...
/**
 * SpeakeasyAPIBuilder is used to configure and build an instance of the SDK.
 * 
 * @package chase_test_4\speakeasy_aPI
 */
class SpeakeasyAPIBuilder
{
     ...
     */
    public function setClient(\GuzzleHttp\ClientInterface $client): SpeakeasyAPIBuilder
    {
     ...
     * @return SpeakeasyAPIBuilder
     */
    public function setSecurity(Models\Shared\Security $security): SpeakeasyAPIBuilder
    {
     ...
     * @return SpeakeasyAPIBuilder
     */
    public function setServerUrl(string $serverUrl, ?array $params = null): SpeakeasyAPIBuilder
    {
     ...
     * @return SpeakeasyAPIBuilder
     */
    public function setServer(string $server): SpeakeasyAPIBuilder
    {
     ...
     * @return SpeakeasyAPI
     */
    public function build(): SpeakeasyAPI
    {
        ...
        return new SpeakeasyAPI($this->sdkConfig);
    }
}